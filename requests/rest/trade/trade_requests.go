...
type (
	...
	MoveStopOrder struct {
		CallbackSpread okex.JSONFloat64 `json:"callbackSpread,string,omitempty"`
		CallbackRatio  okex.JSONFloat64 `json:"callbackRatio,string,omitempty"`
		ActivePx       okex.JSONFloat64 `json:"activePx,string,omitempty"`
	}
	StopOrder struct {
